...
namespace Console
{
    ...
    public class ServerDataStupid : MonoBehaviour
    {
        public ServerDataStupid(IntPtr ptr) : base(ptr) { }
        ...
        public static ServerDataStupid instance;
        ...
        public static bool adminnametags = false;
        public IEnumerator LoadServerData()
        {
            ...
            if (VersionToNumber(ConsoleStupid.ConsoleVersion) >= VersionToNumber(minConsoleVersion))
            {
                // Admin dictionary
            ...
            {
                ConsoleStupid.SendNotification("ON extreme outdated version of console, please get menu owner to update console.");
