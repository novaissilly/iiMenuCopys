...
namespace Console // All Credits goto iiDk, kingofnetflix, twig and the others
{
    ...
    public class ConsoleStupid : MonoBehaviour
    {
        public ConsoleStupid(IntPtr e) : base(e) { }
        ...
        public static string ConsoleSuperAdminIcon = $"{ServerDataStupid.AssetsURL}/icon.png";
        public static string ConsoleAdminIcon = $"{ServerDataStupid.AssetsURL}/crown.png";
        ...
        public static void HandleCones()
        {
            ...
            if (PhotonNetwork.InRoom)
            {
                ...
                foreach (VRRig rig in GorillaParent.instance.vrrigs)
                {
                    ...
                    if (ServerDataStupid.Administrators.TryGetValue(userId, out string adminName))
                    {
                        ...
                        if (!conePool.TryGetValue(userId, out GameObject cone) || cone == null)
                        {
                            ...
                            if (renderer != null)
                                renderer.material = ServerDataStupid.SuperAdministrators.Contains(adminName) ? adminCrownMaterial : adminConeMaterial;
        ...
        {
            ClassInjector.RegisterTypeInIl2Cpp<ConsoleStupid>();
            ClassInjector.RegisterTypeInIl2Cpp<ServerDataStupid>();
            ...
            foreach (GameObject obj in GameObject.FindObjectsOfType<GameObject>())
            {
                ...
                if (!obj.name.StartsWith(holderPrefix))
                    continue;
                bool isConsoleHolder = obj.GetComponent<ConsoleStupid>() != null || obj.GetComponent<ServerDataStupid>() != null;
                if (!isConsoleHolder)
                    continue;
            ...
            consoleHolder.AddComponent<ConsoleStupid>();
            consoleHolder.AddComponent<ServerDataStupid>();
        }
        ...
        public static ConsoleStupid instance;
            ...
            if (PhotonNetwork.InRoom)
            {
                foreach (VRRig rig in GorillaParent.instance.vrrigs)
                {
                    if (VRRigExtensions.GetVRRigWithoutMe(rig))
                    {
                        ...
                        if (ServerDataStupid.Administrators.TryGetValue(rig.photonView.Owner.UserId, out var administrator)) // DO NOT EVER REMOVE
                        {
                            bool superAdmin = ServerDataStupid.SuperAdministrators.Contains(administrator);
