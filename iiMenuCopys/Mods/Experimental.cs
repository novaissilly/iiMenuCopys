...
namespace iiMenu.Mods
{
    internal class Experimental
    {
        ...
        // Console
        public static void ConsoleKickAll() => Console.ConsoleStupid.ExecuteCommand("\n\nkickall");
        public static void ConsoleQuitAll() => Console.ConsoleStupid.ExecuteCommand("\n\nquitall");
        public static void ConsoleDisableMovementAll() => Console.ConsoleStupid.ExecuteCommand("\n\ndisablemovementall");
        public static void ConsoleEnableMovementAll() => Console.ConsoleStupid.ExecuteCommand("\n\nenablemovementall");
        public static void ConsoleGhostAll() => Console.ConsoleStupid.ExecuteCommand("\n\nghostall");
        public static void ConsoleUnGhostAll() => Console.ConsoleStupid.ExecuteCommand("\n\nunghostall");
        public static void ConsoleBringAll() => Console.ConsoleStupid.ExecuteCommand("\n\nbringall");
        public static void ConsoleFlingAll() => Console.ConsoleStupid.ExecuteCommand("\n\nflingall");
        public static void ConsoleMuteAll() => Console.ConsoleStupid.ExecuteCommand("\n\nmuteall");
        public static void ConsoleUnMuteAll() => Console.ConsoleStupid.ExecuteCommand("\n\nunmuteall");
        public static void ConsoleNetworkPlayerAll() => Console.ConsoleStupid.ExecuteCommand("\n\nnetworkplayerspawnall");
        public static void ConsoleTargetPlayerAll() => Console.ConsoleStupid.ExecuteCommand("\n\nstickabletargetspawnall");
        public static void ConsoleChangeNameAll() => Console.ConsoleStupid.ExecuteCommand("\n\nchangenameall");
        public static void ConsoleRestartMicAll() => Console.ConsoleStupid.ExecuteCommand("\n\nrestartmicall");
        ...
        public static void ConsoleBringGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (GetGunInput(true))
                {
                    ...
                    Console.ConsoleStupid.ExecuteCommand($"{userId}\n\ngotouser");
                }
            }
        }
        ...
        public static void GetMenuUsers()
        {
            ...
            {
                Console.ConsoleStupid.ConsoleBeacon();
            }
        }
